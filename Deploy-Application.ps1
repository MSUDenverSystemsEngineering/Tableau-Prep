...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		## <Perform Installation tasks here>
			...
			$exitCode = Execute-Process -Path "$dirFiles\TableauPrep-2022-2-1.exe" -Parameters "REMOVEINSTALLEDAPP=1 ACCEPTEULA=1 DATABASEDRIVERS=1 DESKTOPSHORTCUT=1 /quiet /norestart" -WindowStyle "Hidden" -WaitForMsiExec -PassThru
			If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$exitCode = Execute-Process -Path "$dirFiles\TableauPrep-2022-2-1.exe" -Parameters "/uninstall /quiet" -WindowStyle "Hidden" -WaitForMsiExec -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUO0OSaiEuNF4uknql3b1QIvPT
# J9qgghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFN0p5yIfznpxy736Dnej99erdxN/MA0GCSqGSIb3DQEBAQUABIIBgIvqbgLq
# D0jmsnZzgBIH3uvG3x23/F7Ta+kwetv5zDCseQK8MMeSXubjdCddIxuZ1efYYaZU
# tfyQFOgHB/0Tlp9HlQGiUKT1B+MOmoSOWjaQYhhqnmvlUSgnUMtLsi2XA80yjVyQ
# Y+1Yu94rg/R/ynUaaQ0+MNi7kqHRrA9ln+j7xpsduLVUUH2IwtnuDnptFDmFf/6j
# IY5rf0FE4WqHUY6Jii6OSZMT26e2mHXTKB/bcuIX+S/iVYte3BNnWv0XJ440irOq
# oZS2v0HOjbR1a0pEeRWbMAKVpU8EvPNf2Kd1rcZGy4+aNffudOONnZ1AX5zpDeGD
# WpRYqLkFqs6Jpl66jzdqBgCpXGIqO93phwWLJ/gJ6hQWaHWIyfpavM1EzipVA3qb
# nYD3280dcAn6Zd3UxP1PPjHfPhUQZRXBr9OmKe5RX+urmXg7CxOMCX+olAutriQ2
# jij/9ff6ysznQJ4lIsH1zzlgKgwNuPinRQxP7qdCVA7E9XaUBE86CxR8uQ==
