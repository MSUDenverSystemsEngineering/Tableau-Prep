...
Try {
	...
	[string]$appName = 'Prep Builder'
	[string]$appVersion = '2023.2.0'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'Tableau Prep Builder' -CheckDiskSpace -PersistPrompt

		## Show Progress Message (with the default message)
		Show-InstallationProgress

		## <Perform Pre-Installation tasks here>
		$applicationList = 'Tableau Prep'
			...
			ForEach($application in $installedApplicationList) {
				...
				if($application.UninstallString) {
					...
					if($application.UninstallString.contains("MsiExec.exe") -and ($application.UninstallSubkey)) {
						...
						$exitCode = Execute-Process -Path "MsiExec.exe" -Parameters "/x$($application.UninstallSubkey) /q" -WindowStyle "Hidden"-IgnoreExitCodes '1603, 1605' -PassThru
						If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
					}
					ElseIf($application.UninstallString.contains("modify")) {
		...
		## <Perform Installation tasks here>
			...
			$exitCode = Execute-Process -Path "$dirFiles\TableauPrep-2023-2-0.exe" -Parameters "REMOVEINSTALLEDAPP=1 ACCEPTEULA=1 DATABASEDRIVERS=1 DESKTOPSHORTCUT=1 /quiet /norestart" -WindowStyle "Hidden" -WaitForMsiExec -PassThru
			If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'Tableau Prep Builder' -CloseAppsCountdown 60
		...
		$exitCode = Execute-Process -Path "$dirFiles\TableauPrep-2023-2-0.exe" -Parameters "/uninstall /quiet" -WindowStyle "Hidden" -WaitForMsiExec -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBnR5sHqLF86+EA
# JXNPLR3oSUVkisUuCstc8rNxjJIcTaCCH8AwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCB8OVLWT8SZWwZi
# kIFfKP2KGzfqLaJ8LhBeRWZn2ujhzDANBgkqhkiG9w0BAQEFAASCAYCX1W0tjL1i
# kjU+jnabk/lhxEos7c0fjp0EIa2e5fVjJBrSncRYn6ajofcPbeA/c9s7JHZPKPtC
# NVwI9vFs1jbA53FBytTud+trz5/AON10cItgFcKNE3iekpFOA9K9W5ShUnJEqVmO
# O4LnRBO359qL+exKUn3Cq6Afaon9rGlPlsFsY8ArY9aTsGWgvNzpzCMN+hlhlWov
# hfu80MDmpOq8ugxBVtjeXklKPGBByKkqA2LFP6iw4VlVVrSZ5fQCnYufhXjf24Ya
# OSuF2sRPPytZo+LdTL5zrDCS0ookN0Oi/eoUlfmCn/iplB/ca9LLZBv+6cdv3HyW
# PadusJf6q2ITDm4fh+MHFIqUJcZfvZBjBOJXOIggE+yWxzIkBnU1SF37S+KEez5u
# BXFarTBssebLeJhjZYQRYBK2W+uhh0WX5biBtV/VAyh5466Dz6z3Y8hXFbU4ScqC
# Hb6b4dgmyPiNr3Qon6vHxdYfBLH/E6HI91c/zqXnNWCfT51aforU1rWhggNLMIID
...
# KoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwNjI3MTQx
# MzM5WjA/BgkqhkiG9w0BCQQxMgQwpsmN6HfGPHx6iqu3cqSFv2BryVt7K0xY8esc
# 4zCfRm+2+Tw9nF9Z+Ogk+qYKPcjvMA0GCSqGSIb3DQEBAQUABIICAKAYRfzXwC1i
# t2UGHpmomQ/omQU8dTGZJXVO3CL1yTo18pbKkxg/nKoch6ABniqB/sAgA/6H229H
# cbfTJQFsmRu3B/IE+jo7dTkOSgif+WcFUsQ5EQYCHExVqyL8ar3VQOIbDBoFEHwz
# eqdP3Q3lfggxcUAINUE61ydBeLvV+T7oPvh0gdjWlHjrGXuI4aZyEwsXsZYfO3eJ
# ViJ/TkTzur44tvwTJJzaB4/ZpT4/vvgMeXm8yL5LhQmEj1pkiAM4KeWsKIx4fr4O
# 1kM3umQIGvNJxAZH44SvkZOIkj2eWzf0coWLV6Le1vZvhpY3NnDxaf14KEuECUsU
# a77pCUz2TAiIcO7vwWrGiFQObW7AP8COOXk0yqCZb8uQLT1ulml4gWdFsknSGtcQ
# jhKxYgSB7cZXdbYsYAkCu2LRLkuV5jnllGgQdgoMWyC2DiUR6CmnY006pY/E434G
# KLQ1Xq84Zq8XIFi1y0NZLzcyC/hs4dgrDnvdnGyNHNOZ2fhDya0jWbD83bHHNnfi
# tzz4rdhabVwQw76aOsE7oU2iMJuwaYzbZcaoQq4UGdb2R3Ja6Pkq7WNXliNskGPv
# ip7vi1oz8mCLKyjLuJK9+y98zjh73GFmiVIvohPSfjCWgLDoDe9DmGI+mEl7kOs9
# WVJ0RHtU7RDReRY3I6TAaMOonY6NBxWW
